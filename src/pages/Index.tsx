...
const Index = () => {
  const [heroContent, setHeroContent] = useState({
    title: "Elevate Your\nBusiness Potential",
    subtitle: "Unlock growth with expert corporate training, compliance solutions, and strategic recruitment that drives measurable results."
  });
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setHeroContent({
            ...
            subtitle: data.subtitle || "Unlock growth with expert corporate training, compliance solutions, and strategic recruitment that drives measurable results."
          });
        }
      } catch (error) {
